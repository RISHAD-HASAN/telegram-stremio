...
import os
os.environ.setdefault("DATABASE", "mongodb://localhost:27017/db1,mongodb://localhost:27017/db2")
...
class TestQualityChecker:
    ...
    def test_bluray_vs_hdcam_same_resolution(self):
        ...
        assert "lower source tier" in reason.lower()
    ...
    def test_hdcam_to_bluray_upgrade(self):
        ...
        assert "better source tier" in reason.lower()
    ...
    def test_same_quality_prefer_smaller_size(self):
        ...
        assert "better quality" in reason.lower()
    ...
    def test_same_quality_reject_larger_size(self):
        ...
        assert "lower quality" in reason.lower()
